...
import ChildStores from '../../../StateManagement/Child\'s_Stores/useChildStore';
...
export const sleep = (time:any) => new Promise(
        ...
        Geolocation.getCurrentPosition(
            async(position) => {
              const { latitude, longitude,accuracy,altitude,heading,speed } = position.coords;
                await axios.post("https://findmykids.cyclic.app/child/coordinate",{
                    data:{
                        latitude,
                        longitude,
                        accuracy,
