...
import { Text, View, Image, TextInput, SafeAreaView, ScrollView, Dimensions, TouchableOpacity, Pressable, StyleSheet } from 'react-native';
import { sendPostRequest } from '../../../Helper/SendToServer';
const ImageJPG = require("../../../images/Logo.jpg");
...
const ChildInfo = ({ route }: { route: any }): JSX.Element => {
            ...
            <SafeAreaView>
                <View style={{ ...styles.container }}>
                    ...
                    <TouchableOpacity
                        ...
                        // onPress={() => sendPostRequest(email, "Child", navigation, "GeoLocation", password,serverRoute)}
                        onPress={() => {
...
// ()=>navigation.navigate("GeoLocation" as never)